# This Makefile is for the AI::NeuralNet::Hopfield extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/AI/NeuralNet/Hopfield.pm]
#     AUTHOR => [q[leprevost <leprevost@cpan.org>]]
#     BUILD_REQUIRES => { Test::More=>q[0] }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     LICENSE => q[perl]
#     MIN_PERL_VERSION => q[5.1]
#     NAME => q[AI::NeuralNet::Hopfield]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], Math::SparseMatrix=>q[0.03], Moose=>q[2.0604] }
#     VERSION_FROM => q[lib/AI/NeuralNet/Hopfield.pm]
#     clean => { FILES=>q[AI-NeuralNet-Hopfield-*] }
...
NAME_SYM = AI_NeuralNet_Hopfield
VERSION = 0.05
...
MAKE = make
FULLEXT = AI/NeuralNet/Hopfield
BASEEXT = Hopfield
PARENT_NAME = AI::NeuralNet
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/AI/NeuralNet/Hopfield.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/AI/NeuralNet
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/AI/NeuralNet
...
TO_INST_PM = lib/AI/NeuralNet/Hopfield.pm

PM_TO_BLIB = lib/AI/NeuralNet/Hopfield.pm \
...
DISTNAME = AI-NeuralNet-Hopfield
DISTVNAME = AI-NeuralNet-Hopfield-0.05
...
manifypods : pure_all  \
	lib/AI/NeuralNet/Hopfield.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/AI/NeuralNet/Hopfield.pm $(INST_MAN3DIR)/AI::NeuralNet::Hopfield.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''A simple Hopfiled Network Implementation.'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''leprevost <leprevost@cpan.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: AI-NeuralNet-Hopfield' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Math::SparseMatrix: 0.03' >> META_new.yml
	$(NOECHO) $(ECHO) '  Moose: 2.0604' >> META_new.yml
	$(NOECHO) $(ECHO) '  perl: 5.1' >> META_new.yml
	$(NOECHO) $(ECHO) 'version: 0.05' >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) '{' > META_new.json
	$(NOECHO) $(ECHO) '   "abstract" : "A simple Hopfiled Network Implementation.",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "leprevost <leprevost@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "AI-NeuralNet-Hopfield",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Math::SparseMatrix" : "0.03",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Moose" : "2.0604",' >> META_new.json
	$(NOECHO) $(ECHO) '            "perl" : "5.1"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>A simple Hopfiled Network Implementation.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>leprevost &lt;leprevost@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <PERLCORE VERSION="5,1,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Math::SparseMatrix" VERSION="0.03" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/AI/NeuralNet/Hopfield.pm blib/lib/AI/NeuralNet/Hopfield.pm 
